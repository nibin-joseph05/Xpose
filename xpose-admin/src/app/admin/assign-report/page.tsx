...
export default function AssignReportPage() {
  ...
  const [newAdminStatus, setNewAdminStatus] = useState<'PENDING' | 'APPROVED' | 'REJECTED' | null>(null);
  ...
  const handleAssignOfficer = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(`Failed to assign officer: ${errorText}`);
      }
                      ...
                      >
                        ...
                        <td className="p-4 text-center space-x-2">
                          ...
                          <button
                            ...
                            disabled={report.assignedOfficerId !== undefined || !report.latitude || !report.longitude}
            ...
            >
              ...
              >
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="text-md font-semibold text-blue-300 light:text-blue-700 mb-2">Assign Officer</h4>
                    <select
                    ...
                    <Button
                      ...
                      className="w-full mt-2 bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white disabled:opacity-50 light:from-blue-400 light:to-purple-500 light:hover:from-blue-500 light:hover:to-purple-600"
                    >
                      Assign Officer
                    </Button>
                  </div>
